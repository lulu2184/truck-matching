...
if __name__ == '__main__':
    ...
    visited = listUtil.gen_request_id_list(0)

    print hungaryAlgorithm.DFS_hungary(driver_list,request_list,match_driver_list,match_request_list,visited).max_match()
